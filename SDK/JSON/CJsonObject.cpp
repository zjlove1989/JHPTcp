...
bool CJsonObject::Get(const std::string& strKey, char* strValue, int inSize) const
{
	if (strValue == nullptr)
	{
		return false;
	...
	memcpy_s(strValue, inSize, pJsonStruct->valuestring, strlen(pJsonStruct->valuestring));
